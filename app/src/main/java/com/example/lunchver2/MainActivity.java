...
import com.example.lunchver2.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_saving) {
            ...
            try {
                Processor.getMainProcessor().saveData(sharedPreferences);
        ...
        {
            SharedPreferences sharedPreferences = getSharedPreferences("pick_item_data", Context.MODE_PRIVATE);
            Processor.getMainProcessor().deleteData(sharedPreferences);
        }
